...
const Month = ({
  ...
  const calendarLocale = useMemo(
    () => ({ months: locale.months, weekdays: locale.weekdays }),
    [locale.months, locale.weekdays],
  );
  const renderHeaderSwitcher = useCallback(
    (props) => <HeaderSwitcher {...props} locale={locale} />,
    [locale],
  );
